...
//   subBassRotationIntensity: 10, // Spine rotation intensity
// };
...
//         const subBassEnd = Math.floor(100 / binHz); // 20-60 Hz
//         const lowBassEnd = Math.floor(250 / binHz); // 60-250 Hz
//         const lowMidEnd = Math.floor(1500 / binHz); // 250-1000 Hz
//         const highMidEnd = Math.floor(3000 / binHz); // 1000-2000 Hz
