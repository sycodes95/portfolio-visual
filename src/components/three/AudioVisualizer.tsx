...
const loadOBJ: LoadOBJFunction = (url: string) => {
  return new Promise<OBJData>((resolve, reject) => {
    fetch(url)
...
const catmullRom: CatmullRomFunction = (
  p0: number,
  p1: number,
  p2: number,
  p3: number,
...
const AudioVisualizer = () => {
  ...
  useEffect(() => {
    ...
    const chromaticAberrationShader: ChromaticShader = {
      uniforms: {
        tDiffuse: { value: null },
